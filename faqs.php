          ...
          <dl class="faq">
            ...
            <dd>
              <p id="faq2_desc" class="desc">
                Answer: 8 week / 600 hour
                        (12 hours/ day x 6 days / week x 8 weeks).
              </p>
            </dd>
            <dt>
            ...
            <dd>
              <p id="faq3_desc" class="desc">
                Answer: 1:The applicant must be willing to commit full time – up to 12 hours a day, 6 days a week for the full 8 weeks.
              </p>
            </dd>
            <dt>
            ...
            <dd>
              <p id="faq5_desc" class="desc">
                Answer: No, but it will open up greater opportunities in the labor market because of the acquired skills.
              </p>
            </dd>

            <dt>
              <button aria-expanded="false" aria-controls="faq6_desc">
                Question: Is Serapis RBKs the same as RBK software program ?
              </button>
            </dt>
            <dd>
              <p id="faq6_desc" class="desc">
                Answer: No! Different majors/ specialties:
                <br>
                - Serapis is RBKs English language and digital literacy program.
                <br>
                - Software program is RBKs software engineers program.   
              </p>
            </dd>
            ...
            <dd>
              <p id="faq7_desc" class="desc">
                Answer: RBK provides 2 meals a day, local transportation (Greater Irbid area) RBK does not provide stipends to students.
...
<br>Applicants are not required to have a Tawjihi.
            ...
            <dd>
              <p id="faq9_desc" class="desc">
                ...
                – Microsoft Office Power User - ICDL Certificate – 7 Adv. Modules. <br>
                Adobe Creative Suite Power User - Photoshop. <br>
                – Wordpress Power User – Certificate.  <br>
                – SketchUp Power User. <br>
                - GarageBand Power User.  <br>
...
To inform the applicant of his acceptance.
            ...
            <dd>
              <p id="faq12_desc" class="desc">
                Answer: The start date for the next cohort is 3rd March .if there is any updates  Applicants will be notified subsequent to their acceptance.
              </p>
            </dd>
            ...
            <dd>
              <p id="faq14_desc" class="desc">
                SERAPIS is RBK’s 8 week / 600 hour immersive learning (12 hours/ day x 6 days / week x 8 weeks) 
              </p>
            </dd>
          </dl>
        </div>
